...
export default function SuyuqKraskaTransactionsPage() {
  ...
  const saveTransaction = useCallback(() => {
    ...
    setForm((prev) => ({ ...prev, amountKg: '', note: '' }));
    setEditingTx(null);
    setDialogOpen(false);
  }, [
    editingTx,
  ...
  return (
    <>
                ...
                <TableHead>
                  <TableRow>
                    <TableCell sx={{ minWidth: 140 }}>
                      {t('suyuqKraskaTransactionsPage.table.date')}
                    </TableCell>
                    <TableCell sx={{ minWidth: 140 }}>
                      {t('suyuqKraskaTransactionsPage.table.type')}
                    </TableCell>
                    <TableCell sx={{ minWidth: 200 }}>
                      {t('suyuqKraskaTransactionsPage.table.machine')}
                    </TableCell>
                    <TableCell sx={{ minWidth: 180 }}>
                      {t('suyuqKraskaTransactionsPage.table.amount')}
                    </TableCell>
      ...
      <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)} maxWidth="xs" fullWidth>
        ...
        <DialogContent dividers>
          <DialogContentText>
            {t('suyuqKraskaTransactionsPage.deleteConfirm')}
          </DialogContentText>
        </DialogContent>
        <DialogActions>
