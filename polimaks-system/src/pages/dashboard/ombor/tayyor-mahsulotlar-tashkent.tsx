...
import seedData from 'src/data/tayyor-mahsulotlar-tashkent.json';
...
const STORAGE_KEY = 'ombor-tayyor-mahsulotlar-tashkent';
...
export default function TayyorMahsulotlarTashkentPage() {
  const { t } = useTranslate('pages');

  const title = `${t('tayyorMahsulotlarTashkentPage.title')} | ${CONFIG.appName}`;
  ...
  const currencyLabel = (code: Currency) => {
    switch (code) {
      case 'UZS':
        return t('tayyorMahsulotlarTashkentPage.currency.uzs');
      case 'USD':
        return t('tayyorMahsulotlarTashkentPage.currency.usd');
      case 'RUB':
        return t('tayyorMahsulotlarTashkentPage.currency.rub');
      case 'EUR':
        return t('tayyorMahsulotlarTashkentPage.currency.eur');
      default:
        return code;
    }
  };
  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, md: 5 } }}>
        <Stack spacing={3}>
          <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={2}>
            <Box>
              <Typography variant="h4">{t('tayyorMahsulotlarTashkentPage.title')}</Typography>
              <Typography variant="body2" sx={{ color: 'text.secondary', mt: 0.5 }}>
                {t('tayyorMahsulotlarTashkentPage.subtitle')}
              </Typography>
            </Box>

            <Button variant="contained" onClick={openAdd}>
              {t('tayyorMahsulotlarTashkentPage.add')}
            </Button>
          </Stack>
          ...
          <Card>
            <TableContainer>
              ...
              >
                <TableHead>
                  <TableRow>
                    <TableCell sx={{ minWidth: 140 }}>{t('tayyorMahsulotlarTashkentPage.client')}</TableCell>
                    <TableCell sx={{ minWidth: 150 }}>{t('tayyorMahsulotlarTashkentPage.receivedDate')}</TableCell>
                    <TableCell sx={{ minWidth: 180 }}>{t('tayyorMahsulotlarTashkentPage.supplier')}</TableCell>
                    <TableCell sx={{ minWidth: 160 }}>{t('tayyorMahsulotlarTashkentPage.numberIdentifier')}</TableCell>
                    <TableCell sx={{ minWidth: 140 }}>{t('tayyorMahsulotlarTashkentPage.type')}</TableCell>
                    <TableCell sx={{ minWidth: 200 }}>{t('tayyorMahsulotlarTashkentPage.name')}</TableCell>
                    <TableCell sx={{ minWidth: 120 }}>{t('tayyorMahsulotlarTashkentPage.quantity')}</TableCell>
                    <TableCell sx={{ minWidth: 140 }}>{t('tayyorMahsulotlarTashkentPage.netWeight')}</TableCell>
                    <TableCell sx={{ minWidth: 140 }}>{t('tayyorMahsulotlarTashkentPage.grossWeight')}</TableCell>
                    <TableCell sx={{ minWidth: 160 }}>{t('tayyorMahsulotlarTashkentPage.totalNetWeight')}</TableCell>
                    <TableCell sx={{ minWidth: 160 }}>{t('tayyorMahsulotlarTashkentPage.totalGrossWeight')}</TableCell>
                    <TableCell sx={{ minWidth: 160 }}>{t('tayyorMahsulotlarTashkentPage.price')}</TableCell>
                    <TableCell sx={{ minWidth: 180 }}>{t('tayyorMahsulotlarTashkentPage.totalPrice')}</TableCell>
                    <TableCell sx={{ minWidth: 260 }}>{t('tayyorMahsulotlarTashkentPage.description')}</TableCell>
                    <TableCell align="right" sx={{ width: 100 }}>
                      {t('tayyorMahsulotlarTashkentPage.actions')}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                      ...
                      <TableCell colSpan={15}>
                        ...
                        >
                          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                            {t('tayyorMahsulotlarTashkentPage.empty')}
                          </Typography>
                      ...
                      <TableRow key={item.id} hover>
                        ...
                        <TableCell>
                          <Typography variant="body2">
                            {item.netWeight.toLocaleString()} {t('tayyorMahsulotlarTashkentPage.kg')}
                          </Typography>
                        </TableCell>
                        <TableCell>
                          <Typography variant="body2">
                            {item.grossWeight.toLocaleString()} {t('tayyorMahsulotlarTashkentPage.kg')}
                          </Typography>
                        </TableCell>
                        <TableCell>
                          <Typography variant="body2">
                            {item.totalNetWeight.toLocaleString()} {t('tayyorMahsulotlarTashkentPage.kg')}
                          </Typography>
                        </TableCell>
                        <TableCell>
                          <Typography variant="body2">
                            {item.totalGrossWeight.toLocaleString()} {t('tayyorMahsulotlarTashkentPage.kg')}
                          </Typography>
                        </TableCell>
                        <TableCell>
                          <Typography variant="body2">
      ...
      <Dialog open={dialog.value} onClose={dialog.onFalse} maxWidth="lg" fullWidth>
        <DialogTitle>
          {editing ? t('tayyorMahsulotlarTashkentPage.edit') : t('tayyorMahsulotlarTashkentPage.add')}
        </DialogTitle>
        <DialogContent dividers>
          <Stack spacing={2} sx={{ pt: 1 }}>
            <Grid container spacing={2}>
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  fullWidth
                  type="date"
                  label={t('tayyorMahsulotlarTashkentPage.receivedDate')}
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  fullWidth
                  label={t('tayyorMahsulotlarTashkentPage.supplier')}
                  value={form.supplier}
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  fullWidth
                  label={t('tayyorMahsulotlarTashkentPage.numberIdentifier')}
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  fullWidth
                  label={t('tayyorMahsulotlarTashkentPage.type')}
                  value={form.type}
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  fullWidth
                  label={t('tayyorMahsulotlarTashkentPage.client')}
                  value={form.client}
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  fullWidth
                  label={t('tayyorMahsulotlarTashkentPage.name')}
                  value={form.name}
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  fullWidth
                  type="number"
                  label={t('tayyorMahsulotlarTashkentPage.quantity')}
                  value={form.quantity}
                  onChange={(e) => setForm((prev) => ({ ...prev, quantity: e.target.value }))}
                  inputProps={{ min: 0, step: '1', placeholder: t('tayyorMahsulotlarTashkentPage.quantity') }}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  fullWidth
                  type="number"
                  label={t('tayyorMahsulotlarTashkentPage.netWeight')}
                  value={form.netWeight}
                  onChange={(e) => setForm((prev) => ({ ...prev, netWeight: e.target.value }))}
                  inputProps={{ min: 0, step: '0.01', placeholder: t('tayyorMahsulotlarTashkentPage.netWeight') }}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  fullWidth
                  type="number"
                  label={t('tayyorMahsulotlarTashkentPage.grossWeight')}
                  value={form.grossWeight}
                  onChange={(e) => setForm((prev) => ({ ...prev, grossWeight: e.target.value }))}
                  inputProps={{ min: 0, step: '0.01', placeholder: t('tayyorMahsulotlarTashkentPage.grossWeight') }}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  fullWidth
                  type="number"
                  label={t('tayyorMahsulotlarTashkentPage.totalNetWeight')}
                  ...
                  inputProps={{
                    min: 0,
                    step: '0.01',
                    placeholder: t('tayyorMahsulotlarTashkentPage.totalNetWeight'),
                  }}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  fullWidth
                  type="number"
                  label={t('tayyorMahsulotlarTashkentPage.totalGrossWeight')}
                  ...
                  inputProps={{
                    min: 0,
                    step: '0.01',
                    placeholder: t('tayyorMahsulotlarTashkentPage.totalGrossWeight'),
                  }}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  fullWidth
                  type="number"
                  label={t('tayyorMahsulotlarTashkentPage.price')}
                  value={form.price}
                  onChange={(e) => setForm((prev) => ({ ...prev, price: e.target.value }))}
                  inputProps={{ min: 0, step: '0.01', placeholder: t('tayyorMahsulotlarTashkentPage.price') }}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  select
                  fullWidth
                  label={t('tayyorMahsulotlarTashkentPage.priceCurrency')}
              ...
              <Grid size={{ xs: 12 }}>
                <TextField
                  fullWidth
                  label={t('tayyorMahsulotlarTashkentPage.description')}
            ...
            <Typography variant="caption" sx={{ color: 'text.secondary' }}>
              {t('tayyorMahsulotlarTashkentPage.localHint')}
            </Typography>
          </Stack>
        </DialogContent>
        <DialogActions>
          <Button onClick={dialog.onFalse} color="inherit">
            {t('tayyorMahsulotlarTashkentPage.cancel')}
          </Button>
          <Button onClick={handleSave} variant="contained" disabled={!canSave}>
            {t('tayyorMahsulotlarTashkentPage.save')}
          </Button>
        </DialogActions>
      </Dialog>

      <Dialog open={deleteDialog.value} onClose={deleteDialog.onFalse} maxWidth="xs" fullWidth>
        <DialogTitle>{t('tayyorMahsulotlarTashkentPage.deleteConfirm')}</DialogTitle>
        <DialogContent>
          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
            {t('tayyorMahsulotlarTashkentPage.deleteHint')}
          </Typography>
        </DialogContent>
        <DialogActions>
          ...
          <Button onClick={handleDelete} color="error" variant="contained">
            {t('tayyorMahsulotlarTashkentPage.delete')}
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <ActionsMenu
        ...
        labels={{ edit: t('tayyorMahsulotlarTashkentPage.edit'), delete: t('tayyorMahsulotlarTashkentPage.delete') }}
      />
    </>
  );
}
